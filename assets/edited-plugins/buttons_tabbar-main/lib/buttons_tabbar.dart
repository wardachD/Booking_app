...
class ButtonsTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  ///
  /// If [Color] is not provided, [Theme.of(context).accentColor] is used.
  final Color? backgroundColorGlobal;
    ...
    return Padding(
      ...
      child: TextButton(
        ...
        style: ButtonStyle(
            ...
            padding:
                MaterialStateProperty.all(EdgeInsets.symmetric(horizontal: 0)),
    ...
    return Opacity(
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) => SizedBox(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: widget.backgroundColorGlobal,
              ...
              boxShadow: [
                BoxShadow(
                  ...
                  spreadRadius: 0,
                  blurRadius: 1,
                  offset: const Offset(0, 3), // zmienia położenie cieni
                ),
              ],
            ),
            child: SingleChildScrollView(
              ...
              padding: widget.center ? _centerPadding : EdgeInsets.all(0),
              child: Row(
